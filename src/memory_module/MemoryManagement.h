...
public:
    ...
    void updateAssociatedObjects(const std::map<int, int>& matches, std::vector<Object*>& currentObservation, int streamId);
    long pickUniqueId();
    void updateObjectStatus(int& streamId, float, std::vector<int>&);
